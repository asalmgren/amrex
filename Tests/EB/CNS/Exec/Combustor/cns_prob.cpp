...
extern "C" {
                         ...
                         const amrex_real* /*probhi*/)
    {
        ...
        inflow_state[CNS::Density] = rho;
        inflow_state[CNS::Xmom]    = 0.0;
        inflow_state[CNS::Ymom]    = 0.0;
        inflow_state[CNS::Zmom]    = rho*v;
        inflow_state[CNS::Eden]    = rhoe + 0.5*rho*v*v;
        inflow_state[CNS::Eint]    = rhoe;
        inflow_state[CNS::Temp]    = CNS::h_prob_parm->inflow_T;
